...
function CategoriesSearch() {
  return (
    <div className='flex flex-col p-2 w-[250px] border-b-2 border-[white]-600 bg-gray-200'>
      ...
      <div className=' flex border-b-2 p-2 border-blue-400 bg-red-700'>
        ...
        <p className='border-b-2 border-blue-400 p-3 w-full cursor-pointer hover:bg-slate-400 duration-300'>
          Selon le prix des livres
        </p>
    </div>
