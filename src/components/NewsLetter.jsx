  ...
  return (
    <div className="flex flex-col gap-6 my-10">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-row gap-4 ">
          <img src={Twitter} alt="twitter" className="w-[50px] h-[50px] cursor-pointer" />
          <span className="cursor-pointer my-auto">Twitter</span>
        </div>
        <div className="flex flex-row gap-4 ">
          <img src={Linkedin} alt="linkedin" className="w-[50px] h-[50px] cursor-pointer" />
          <span className="cursor-pointer my-auto">Linkedin</span>
        </div>
        <div className="flex flex-row gap-4 ">
      ...
      <h1 className="text-center text-2xl font-bold">TOP POST</h1>
