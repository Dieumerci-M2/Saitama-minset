...
const PaiyementModal = ({ Visible, Desciption, Prix, onClose }) => {
  ...
  return (
    <article
      ...
      <main className="bg-white w-[400px] h-[400px] rounded-lg p-10 flex flex-col justify-between">
        ...
        <section className="mt-8">
          <button onClick={() => {
            onClose()
            }}  variant="filled" className="w-[100px] bg-red-700 text-white font-medium">
            Close
          </button>
        </section>
      </main>
