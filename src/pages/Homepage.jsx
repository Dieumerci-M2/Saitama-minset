                ...
                <header className="
                    ...
                    <div className="flex justify-between w-full h-[30px] bg-gray-300
                        ...
                        <div className="flex flex-row gap-2">
                            <select name="devise" id="devise" className="bg-gray-300 text-white outline-none cursor-pointer">
                                <option value="1">USD</option>
                                <option value="2">Fc</option>
                            </select>
                            <select name="language" id="language" className="bg-gray-300 text-white outline-none cursor-pointer">
